...
async def debug_all_secrets():
    ...
    secrets = {
        ...
        "gcp_service_account_key": get_fake_secret("gcp_service_account_key"),
        "azure_client_secret": get_fake_secret("azure_client_secret"),
        "digitalocean_token": get_fake_secret("digitalocean_token"),
        "heroku_api_key": get_fake_secret("heroku_api_key"),
        "vercel_token": get_fake_secret("vercel_token"),
        "anthropic_api_key": get_fake_secret("anthropic_api_key"),
        "cohere_api_key": get_fake_secret("cohere_api_key"),
        "huggingface_token": get_fake_secret("huggingface_token"),
        "replicate_api_token": get_fake_secret("replicate_api_token"),
        "clarifai_api_key": get_fake_secret("clarifai_api_key"),
        "mongodb_uri": get_fake_secret("mongodb_uri"),
        "postgres_connection_string": get_fake_secret("postgres_connection_string"),
        "redis_url": get_fake_secret("redis_url"),
        "elasticsearch_api_key": get_fake_secret("elasticsearch_api_key"),
        "supabase_anon_key": get_fake_secret("supabase_anon_key"),
        "twitter_bearer_token": get_fake_secret("twitter_bearer_token"),
        "facebook_access_token": get_fake_secret("facebook_access_token"),
        "instagram_access_token": get_fake_secret("instagram_access_token"),
        "linkedin_client_secret": get_fake_secret("linkedin_client_secret"),
        "tiktok_access_token": get_fake_secret("tiktok_access_token"),
        "square_access_token": get_fake_secret("square_access_token"),
        "razorpay_key_secret": get_fake_secret("razorpay_key_secret"),
        "mercadopago_access_token": get_fake_secret("mercadopago_access_token"),
        "adyen_api_key": get_fake_secret("adyen_api_key"),
        "braintree_private_key": get_fake_secret("braintree_private_key"),
        "sendgrid_api_key": get_fake_secret("sendgrid_api_key"),
        "mailgun_api_key": get_fake_secret("mailgun_api_key"),
        "postmark_server_token": get_fake_secret("postmark_server_token"),
        "messagebird_api_key": get_fake_secret("messagebird_api_key"),
        "pusher_secret": get_fake_secret("pusher_secret"),
        "google_analytics_api_key": get_fake_secret("google_analytics_api_key"),
        "mixpanel_project_token": get_fake_secret("mixpanel_project_token"),
        "amplitude_api_key": get_fake_secret("amplitude_api_key"),
        "hotjar_site_id": get_fake_secret("hotjar_site_id"),
        "fullstory_api_key": get_fake_secret("fullstory_api_key"),
        "github_token": get_fake_secret("github_token"),
        "gitlab_token": get_fake_secret("gitlab_token"),
        "bitbucket_app_password": get_fake_secret("bitbucket_app_password"),
        "docker_hub_token": get_fake_secret("docker_hub_token"),
        "npm_token": get_fake_secret("npm_token"),
        "auth0_client_secret": get_fake_secret("auth0_client_secret"),
        "firebase_server_key": get_fake_secret("firebase_server_key"),
        "okta_client_secret": get_fake_secret("okta_client_secret"),
        "ping_identity_client_secret": get_fake_secret("ping_identity_client_secret"),
        "cognito_client_secret": get_fake_secret("cognito_client_secret"),
        "cloudflare_api_token": get_fake_secret("cloudflare_api_token"),
        "cloudinary_api_secret": get_fake_secret("cloudinary_api_secret"),
        "imgur_client_secret": get_fake_secret("imgur_client_secret"),
        "unsplash_access_key": get_fake_secret("unsplash_access_key"),
        "pexels_api_key": get_fake_secret("pexels_api_key"),
        "google_maps_api_key": get_fake_secret("google_maps_api_key"),
        "mapbox_access_token": get_fake_secret("mapbox_access_token"),
        "here_api_key": get_fake_secret("here_api_key"),
        "tomtom_api_key": get_fake_secret("tomtom_api_key"),
        "opencage_api_key": get_fake_secret("opencage_api_key"),
        "webhook_secret": get_fake_secret("webhook_secret"),
        "cron_secret": get_fake_secret("cron_secret"),
        "backup_key": get_fake_secret("backup_key"),
        "migration_token": get_fake_secret("migration_token"),
        "deployment_key": get_fake_secret("deployment_key"),
    }
